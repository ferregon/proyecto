...
String[] titulos={"Codigo","Categoria" ,"Nombre", "Precio,","Stock","Imagen","Direccion"};
...
txtnomimagen.setText("");
    ...
    private void initComponents() {
        ...
        btn_modificar.setBounds(710, 290, 80, 70);
        ...
        btn_salir.setBounds(890, 290, 80, 80);
        ...
        btn_eliminar.setBounds(710, 180, 70, 70);
        ...
        btn_grabar.setToolTipText("Guardar");
        btn_grabar.setAutoscrolls(true);
        ...
        btn_grabar.setBounds(882, 80, 70, 70);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(280, 10, 690, 48);

        aux.setToolTipText("Buscar");
